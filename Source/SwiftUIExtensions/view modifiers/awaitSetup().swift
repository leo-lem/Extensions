...
public extension View {
  func awaitSetup<T: ObservableObject & Sendable>(setup: @escaping () async -> T) -> some View {
    awaitSetup(setup: setup, placeholder: { ProgressView() })
  }
  
  func awaitSetup<T: ObservableObject & Sendable, Placeholder: View>(
...
@available(iOS 15, macOS 12, tvOS 15, watchOS 8, *)
private struct AwaitSetup<T: ObservableObject & Sendable, Placeholder: View>: ViewModifier {
